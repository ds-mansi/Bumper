export const StaticData = {
    Meta_title:" Bumper to Bumper",
    Meta_description:"Visit Bumper to Bumper Demo Store | Bumper to Bumper is your local great value family retailer shop. Find latest seasonal looks for Women, Men and kids, plus a huge range of homeware.",
    locator_breadcrumb:"Store Locator",
    FindLocationtext:"Find a Location",
    Usemylocation:"Use my location",
    Search:"Search",
    Brandname:"Bumper To Bumper",
    miles:"miles",
